...
export default function Navbar() {
    ...
    return (
        <nav className="bg-white-400 py-4">
            <div className="max-w-7xl mx-auto flex items-center justify-between h-16 px-4 border-solid border-slate-600">
                <div className="flex-shrink-0 font-bold tracking-wider w-16">
